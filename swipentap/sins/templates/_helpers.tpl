...
{{- else }}
Host={{ .Values.postgresql.externalHost }}:{{ .Values.postgresql.externalPort }};Database={{ .Values.postgresql.externalDatabase }};Username={{ .Values.postgresql.externalUser }};Password={{ .Values.postgresql.externalPassword }}
{{- end }}
{{- end }}
